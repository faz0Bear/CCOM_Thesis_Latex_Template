...
\NewDocumentCommand{\addchapter}{s m}{%
	...
	} % * 不增加章
	{
		...
		{
			\begin{center}
				\zihao{-2} \songti 第\chinesenumber{\value{chapter}}章\quad #2
			\end{center}
		}
...
\newcommand{\RomannumToArabic}[1]{%
	\setcounter{Romancounter}{0}%
	\IfStrEqCase{#1}{%
		{i}{\setcounter{Romancounter}{1}}%
		{ii}{\setcounter{Romancounter}{2}}%
		{iii}{\setcounter{Romancounter}{3}}%
		{iv}{\setcounter{Romancounter}{4}}%
		{v}{\setcounter{Romancounter}{5}}%
		{vi}{\setcounter{Romancounter}{6}}%
		{vii}{\setcounter{Romancounter}{7}}%
		{viii}{\setcounter{Romancounter}{8}}%
		{ix}{\setcounter{Romancounter}{9}}%
		{x}{\setcounter{Romancounter}{10}}%
		{I}{\setcounter{Romancounter}{1}}%
		{II}{\setcounter{Romancounter}{2}}%
		{III}{\setcounter{Romancounter}{3}}%
		{IV}{\setcounter{Romancounter}{4}}%
		...
		{IX}{\setcounter{Romancounter}{9}}%
		{X}{\setcounter{Romancounter}{10}}%
	}[\PackageWarning{Romconvert}{Invalid Roman numeral input: #1}]%
}
