...
\newcommand{\chititle}{中文标题}
\newcommand{\chisubtitle}{——中文副标题}
...
\renewcommand{\contentsname}{\vspace*{-0.75em} \hfill \zihao{-2}\color{black}目\hspace*{0.75em}录 \hfill}  % 修改目录的标题
...
% 自定义 subsection 标题:第x节
\renewcommand{\thesubsection}{第\chinesenumber{\value{subsection}}节}
...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			\noindent
			\includegraphics[width=0.6\textwidth]{media/ccom_logo.eps}\vspace{2cm}
		\end{center}
		...
		\begin{center}
			...
			{ \heiti \fontsize{32pt}{32pt}\selectfont\bfseries \chititle \protect\\
				\vspace*{0.25em}
	...
	{\large
		...
		本人郑重声明：此处所提交的\degree 士学位论文《\chititle 》，是本人在导师指导下，在中央音乐学院攻读\degree 士学位期间独立进行研究工作所取得的成果。据本人所知，论文中除已注明部分外不包含他人已发表或撰写过的研究成果。对本文的研究工作做出重要贡献的个人和集体，均已在文中以明确方式注明并表示了谢意。本声明的法律结果将完全由本人承担。
		...
		《\chititle 》系本人在中央音乐学院攻读\degree 士学位期间在导师指导下完成的\degree 士学位论文。本人完全了解中央音乐学院关于保存、使用学位论文的规定，同意学校保留并向有关部门送交论文的复印件和电子版本，允许论文被查阅和借阅。
	...
	使用“\textbf{$\backslash \text{ref\{fig:1.x\}}$}"引用公式\ref{fig:1.1}。
	...
	\begin{table}[h]
		...
		\begin{tabular}{ccccccc}
			\hline
			Pitch (MIDI) & Onset & Duration  & String & Position & Finger & Type \\ \hline
			64           & 0     & 2         & 2 	  & 1 		 & 2 	  & 1 \\
			69           & 2     & 2         & 2 	  & 3		 & 3 	  & 1 \\
			73           & 0     & 3         & 2 	  & 3 		 & 5 	  & 1 \\
			69           & 3     & 1         & 2 	  & 3 		 & 3 	  & 1 \\
